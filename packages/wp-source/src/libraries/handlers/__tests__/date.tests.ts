...
describe("date", () => {
  test("get two pages of year 2016", async () => {
    ...
    // source.fetch("/2016/")
    state.source.data["/2016/"] = { isFetching: true };
    ...
    state.source.data["/2016/page/2/"] = { isFetching: true };
  ...
  test.skip("doesn't exist in dataMap (2016/10)", async () => {
    ...
    state.source.data["/2016/10/"] = { isFetching: true };
  ...
  test("doesn't exist in dataMap (2016/10/25)", async () => {
    ...
    state.source.data["/2016/10/25/"] = { isFetching: true };
